...
describe("DayCare", () => {
  ...
  describe("addChild", () => {
    ...
    it("should not add a child over the 'ageLimit'", () => {
      ...
      expect(mock).toHaveBeenCalledWith("Unable to add child, they are over the age limit");
    ...
    it("should not add a child if already at capacity", () => {
      ...
      expect(mock).toHaveBeenCalledWith("At capacity, unable to add more children");
  ...
  describe("pickupChild", () => {
    it("should remove the first child found with a given name from 'children' and return it", () => {
      ...
      expect(mock).toHaveBeenCalledWith(`Picked up ${child2.name} from day care`);
    ...
    it("should return undefined and remove no children if child is not in 'children'", () => {
      ...
      expect(mock).toHaveBeenCalledWith("Child not found");
